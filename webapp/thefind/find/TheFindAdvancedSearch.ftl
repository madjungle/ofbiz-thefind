            ...
            <tr>
              ...
              <td valign="middle">
                <select name="productStoreId" id="searchProductStoreId" onchange="javascript:selectChange(document.getElementById('advToKeywordSearchform'), document.getElementById('searchProductStoreId'));">
                  <#if theFindConfigList?has_content>
                    <#list theFindConfigList as theFindConfig>
                      <#assign productStore = delegator.findOne("ProductStore", {"productStoreId" : theFindConfig.productStoreId}, true) />
